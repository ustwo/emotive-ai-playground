...
---
## Architecture
Emotive AI Agent Builder is written in Typescript and deployed to Vercel. The main entry for the application is ```gui.ts```. The main classes of the application are as follows, roughly in order of appearance:
...
### Features
- Basic analytics are planned using [Vercel KV storage](https://vercel.com/docs/storage/vercel-kv) to track whether page visits from unique links result in a completed Agent.
