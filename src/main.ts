import { URL_API_OPENAI } from "./constants";
import "./style.css";
...
let setup: string =
  "You are a digital assistant at a company called Bikerosoft. End every response with 'it's like riding a bike... rosoft!!'";
...
async function makeLLMRequest(sender: string, outgoingMessage: string) {
  ...
  try {
    console.log("Paty payload", payload);
